...
export class BannerDemoComponent {
  carouselSlides = [
    {
      img: 'https://dbf13ja5t0ooe.cloudfront.net/assets/images/demo/banner1.png',
      alt: 'ASP.NET',
    ...
    {
      img: 'https://dbf13ja5t0ooe.cloudfront.net/assets/images/demo/banner2.png',
      alt: 'Visual Studio',
      caption:
    ...
    {
      img: 'https://dbf13ja5t0ooe.cloudfront.net/assets/images/demo/banner3.png',
    ...
    {
      img: 'https://dbf13ja5t0ooe.cloudfront.net/assets/images/demo/banner4.png',
      alt: 'Eben Monney',
      caption:
